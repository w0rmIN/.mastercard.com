...
<body style="background: #000 url(/img/welcomepage-f_cn.jpg) no-repeat center top;min-width:10px">

<?php
	} else { ?>

<body style="background: #000 url(/img/welcomepage-f.jpg) no-repeat center top;min-width:10px">
...
if ($defaultBrowserLanguage == "zh-cn") { ?>
			...
			<div style="color:#999;font-size:16px;margin:330px auto 0;width:560px;line-height:1.5em;text-align: justify;">
				...
				<div style="text-align:center;margin-top:10px;"><a href="/country/?cn"><img src="/img/btn_enter_cn.png" height="36" width="159" alt="Enter" /></a></div>
			</div>
...
<?php
			...
			<div style="color:#999;font-size:16px;margin:330px auto 0;width:560px;line-height:1.5em;text-align: justify;">
				...
				<div style="text-align:center;margin-top:10px;"><a href="/the-index/"><img src="/img/btn_enter.png" height="36" width="159" alt="Enter" /></a></div>
			</div>
